 ...
 * @author Admin
 */
@WebServlet(name = "getAllProcessedApplication", urlPatterns = {"/getallprocessedapplication"})
public class getAllProcessedApplication extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (session != null && (boolean) session.getAttribute("checkLogin") == true && ((String) session.getAttribute("role_user")).equals("staff")) {
                ...
                list_appli = fillterAppli(appli_dao.getAllProcessedApplication(), stu_id, appli_id);
                ...
                request.getRequestDispatcher("ViewAllProcessedApplication.jsp").forward(request, response);
            }
        }
    }
